...
const std::vector<Node*> Astar::GetPath(std::vector<Node*> navNodes, Node* start, Node* end)
{
...
const std::vector<Node*> Astar::ComputePath(std::vector<Node*> navNodes, Node* start, Node* end)
{
